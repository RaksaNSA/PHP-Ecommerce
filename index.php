	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
		    			<div class="col-md pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">+855 10203813</span>
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
					    	<div class="icon mr-2 d-flex justify-content-center align-items-center"><span class="icon-paper-plane"></span></div>
						    <span class="text">raksa@email.com</span>
					    </div>
				...
				<div class="col-sm col-md-6 col-lg ftco-animate">
					<div class="product">
						...
						<div class="text py-3 px-3">
							<h3><a href="#"><?php echo htmlspecialchars($products['name']);?></a></h3>
							<div class="d-flex">
								<div class="pricing">
									<p class="price"><span class="mr-2 price-dc"><?php echo htmlspecialchars($products['price']); ?></span><span class="price-sale">$80.00</span></p>
								</div>
								<div class="rating">
									<p class="text-right">
