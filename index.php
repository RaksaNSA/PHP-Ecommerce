...
<?php include_once __DIR__ .'../themes/navegation.php';?>
                    ...
                    <div class="product">
                        ...
                        <div class="text py-3 px-3">
                            ...
                            <div class="d-flex">
                                <div class="pricing">
                                    <p class="price">
                                        <span class="mr-2 price-dc"><?php echo htmlspecialchars($product['price']); ?></span>
                                        <?php if (!empty($product['sale_price'])): ?>
                                            <span class="price-sale"><?php echo htmlspecialchars($product['sale_price']); ?></span>
                                        <?php endif; ?>
                                    </p>
                                </div>
                                <div class="rating">
    ...
    <section class="ftco-section bg-light">
    	...
    	<div class="container">
    		<div class="row">
    			<?php
// Query all products (customize LIMIT or ORDER BY as needed)
try {
